...
// Create withdraw request --- only for sellers
router.post(
  ...
  catchAsyncErrors(async (req, res, next) => {
    try {
      ...
      // Send email notification to the seller about the withdraw request
      try {
        await sendMail({
      ...
      // Update the available balance of the seller
...
router.put(
  ...
  catchAsyncErrors(async (req, res, next) => {
    try {
      ...
      // Update seller's transections with the details of the completed withdraw
